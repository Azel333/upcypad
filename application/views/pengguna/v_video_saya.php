...
<link href="https://fonts.googleapis.com/icon?family=Material+Icons" rel="stylesheet">
	...
	<div class="content">
		<div class="container">
			<div class="row">
				<?php
	$query_user = $this->db->get_where('tutorial_video', array('id_meta'=> $this->session->userdata('id_meta')))->result_array();
...
?>
        ...
        <source src="<?php echo base_url('assets/video/pengguna/').$row['upload_video'] ?>">
    </video>
				<?php
	}
?>
